...
struct tournament {
  ...
  int umrtvi(int x, int l, int r, int preskoci) {
    int pravi_l = preskoci;
    int pravi_r = preskoci + h[x].alive - 1;

    if (pravi_r < __L || __L < pravi_l) return -1; 
    if (l == r) {
      h[x].alive = false;
      h[x].sum = 0;
      return x;
  ...
  llint getSuma(int x, int l, int r, int preskoci) {
    int pravi_l = preskoci;
  ...
  void postaviInterval(int x, int l, int r, int preskoci) { 
    int pravi_l = preskoci;
    int pravi_r = pravi_l + h[x].alive - 1;
